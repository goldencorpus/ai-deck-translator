...
def main():
    ...
    parser = argparse.ArgumentParser(description='Translate a PowerPoint presentation with enhanced translator V2')
    ...
    parser.add_argument('--quality', choices=['professional', 'standard', 'draft', 'economy'], 
                        default='professional', help='Translation quality level')
    ...
    parser.add_argument('--clear-cache', action='store_true', help='Clear the translation cache')
