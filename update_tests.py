...
def update_file(file_path):
    ...
    # Replace in imports
    updated_content = re.sub(r'from gslides_translator', 'from ai_deck_translator', content)
    updated_content = re.sub(r'import gslides_translator', 'import ai_deck_translator', updated_content)
    
    # Replace in patch decorators and other references
    updated_content = re.sub(r"@patch\('gslides_translator", "@patch('ai_deck_translator", updated_content)
    updated_content = re.sub(r"'gslides_translator", "'ai_deck_translator", updated_content)
    updated_content = re.sub(r'"gslides_translator', '"ai_deck_translator', updated_content)
