...
import threading
import time
from ai_deck_translator.web.app import (
    create_app,
...
class TestWebInterface(unittest.TestCase):
    ...
    def setUp(self):
        ...
        translation_state.update(
            {"running": False, "progress": 0, "console_output": [], "result_url": None}
        )
    ...
    def test_start_translation_invalid(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(
            b"Please provide a valid Google Slides presentation ID", response.data
        )
    ...
    def test_get_progress(self):
        ...
        self.assertEqual(
            data["result_url"], "https://docs.google.com/presentation/d/test"
        )
