...
class TestExtractor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_service.presentations().get().execute.return_value = self.mock_presentation
    
    def test_extract_text(self):
        """Test that text is correctly extracted from a presentation."""
        # Call the function with the mock service
        text_dict, slide_metadata = extract_text(self.mock_service, 'test_presentation_id')
        
        # Verify the service was called correctly
        self.mock_service.presentations().get.assert_called_once_with(presentationId='test_presentation_id')
    ...
    def test_extract_text_empty_presentation(self):
        ...
        # Call the function with the mock service
        text_dict, slide_metadata = extract_text(self.mock_service, 'empty_presentation_id')
    ...
    def test_extract_text_error_handling(self):
        ...
        self.mock_service.presentations().get().execute.return_value = problematic_presentation
        
        # Call the function with the mock service
        text_dict, slide_metadata = extract_text(self.mock_service, 'problematic_presentation_id')
