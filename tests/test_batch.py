...
class TestBatch(unittest.TestCase):
    ...
    def test_split_dict_into_smart_batches(self):
        ...
        test_dict = {
            ...
            "key4": "Short",
            "key5": "This is a very long text " + "word " * 100  # Approximately 100 more tokens
        }
        ...
        batches = split_dict_into_smart_batches(test_dict, max_input_tokens=50, prompt_tokens=20)
