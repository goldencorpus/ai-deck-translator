...
class TestTranslator(unittest.TestCase):
        ...
        slide_metadata = [
            {
                "slide_number": 1,
                "title": "Test Slide",
                "content": ["Original text 1", "Original text 2"],
            }
        ]

        # Call the function
        result = translate_batch(
            batch, 0, slide_metadata, "en", "fr", api_key="test_key"
        )
    ...
    def test_translate_slides(
        self, mock_auth, mock_update, mock_extract, mock_translate
    ):
