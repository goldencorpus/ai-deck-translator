...
def test_key_verification():
    ...
    exact_match, missing_keys, format_changes = verify_translation_keys(original_keys, translated_keys)
    ...
    assert exact_match == False, "Should not be an exact match"
    assert "slide1_shape1" in missing_keys, "slide1_shape1 should be missing"
    assert "slide1_shape0" in format_changes, "slide1_shape0 format change should be detected"
