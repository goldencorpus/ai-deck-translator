...
class BaseTranslationService(TranslationService):
    ...
    def __init__(self, supported_languages: Dict[str, str], supported_quality_levels: Dict[str, str]):
        """
    ...
    def translate_document(self, document_id: DocumentId, adapter: DocumentAdapter, 
                         request_params: dict) -> TranslationResult:
        """
    ...
    def translate_elements(self, request: TranslationRequest) -> TranslationResult:
        ...
        try:
            ...
            for model, cost in batch_costs.items():
                ...
                cost_data["models"][model]["input_tokens"] += cost.get("input_tokens", 0)
                cost_data["models"][model]["output_tokens"] += cost.get("output_tokens", 0)
