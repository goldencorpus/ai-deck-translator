...
class DocumentAdapter(ABC):
    ...
    @abstractmethod
    def extract_text(self, document_id: DocumentId) -> tuple[TextElements, MetadataType]:
        """
    ...
    @abstractmethod
    def update_document(self, document_id: DocumentId, translated_elements: TextElements, 
                       target_language: str) -> DocumentId:
        """
