            ...
            for element in slide.get("pageElements", []):
                ...
                if shape and "text" in shape:
                    ...
                    if full_text:
                        ...
                        if (
                            not slide_info["title"]
                            and element.get("transform", {}).get("scaleX", 0) > 0
                        ):
                        ...
                        for col_idx, cell in enumerate(row.get("tableCells", [])):
                            if "text" in cell:
                                ...
                                if cell_text:
                                    ...
                                    cell_id = (
                                        f"{element['objectId']}_r{row_idx}_c{col_idx}"
                                    )
            ...
            if "slideProperties" in slide and "notesPage" in slide["slideProperties"]:
                ...
                if "pageElements" in notes_page:
                    for notes_element in notes_page["pageElements"]:
                        if (
                            "shape" in notes_element
                            and "text" in notes_element["shape"]
                        ):
                            notes_text_elements = notes_element["shape"]["text"].get(
                                "textElements", []
                            )
                            notes_text = ""
                            ...
                            if notes_text:
                                ...
                                logger.debug(
                                    f"Extracted notes for slide {slide_number}"
                                )
