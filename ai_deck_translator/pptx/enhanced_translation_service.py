...
from ..pptx.enhanced.cache import (
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=min(max_workers, len(batches))) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_batch):
                ...
                try:
                    ...
                    cost_data[model_name]["output_tokens"] += batch_cost["output_tokens"]
            ...
            if element_id.startswith("slide_"):
                ...
                for slide in metadata:
                    if slide.get("slide_number") == slide_num:
                        context_items.append(f"Slide {slide_num}: {slide.get('title', '')}")
                        break
                ...
                if use_qa:
                    ...
                    if issues and quality_score < 70:
                        fixed_translation = self._fix_translation_issues(
                            original_text, translation, issues, model_name,
...
Please fix the issues and provide the corrected translation, maintaining the original formatting and style."""
        ...
        # Call the model
        try:
            result = translator.translate(system_prompt, user_prompt, DummyCostTracker())
            ...
            if hasattr(result, "content") and isinstance(result.content, str):
                ...
                elif isinstance(result.content[0], dict) and "translation" in result.content[0]:
