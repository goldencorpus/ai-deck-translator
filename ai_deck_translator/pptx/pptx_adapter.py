    ...
    def extract_text(self, document_id: str) -> Tuple[TextElements, MetadataType]:
        ...
        for slide_index, slide in enumerate(prs.slides):
            ...
            slide_metadata.append({
                ...
                "notes": slide_notes,
                "layout": slide.slide_layout.name if hasattr(slide, "slide_layout") and hasattr(slide.slide_layout, "name") else "Unknown"
            })
        
        return text_elements, slide_metadata
    
    def update_document(self, document_id: str, translated_elements: TextElements, 
        ...
        output_file = os.path.join(
            file_dir, 
            f"{name_parts[0]}_{target_language}{name_parts[1]}"
        )
