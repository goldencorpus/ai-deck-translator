...
def get_translation_cache_key(text: str, source_language: str, target_language: str, model: Optional[str] = None) -> str:
    """
...
def save_to_translation_cache(text: str, translation: str, source_language: str, target_language: str, model: Optional[str] = None) -> bool:
    """
    ...
    try:
        ...
        cache_key = get_translation_cache_key(text, source_language, target_language, model)
...
def get_from_translation_cache(text: str, source_language: str, target_language: str, model: Optional[str] = None) -> Optional[str]:
    """
