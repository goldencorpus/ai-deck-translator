...
class Glossary:
    ...
    def save_term(self, term: str, translation: str, 
    ...
    def lookup_term(self, term: str, source_language: str, 
    ...
    def find_terms_in_text(self, text: str, source_language: str, 
    ...
    def apply_glossary_to_text(self, text: str, source_language: str, 
...
def save_term(term: str, translation: str, 
              source_language: str, target_language: str,
              case_sensitive: bool = False,
              notes: Optional[str] = None,
              glossary_file: Optional[str] = None) -> None:
    """
    Save a term to the glossary.
    ...
    glossary.save_term(term, translation, source_language, target_language, case_sensitive, notes)

def lookup_term(term: str, source_language: str, 
                target_language: str, glossary_file: Optional[str] = None) -> Optional[str]:
    """
    Look up a term in the glossary.
...
def find_terms_in_text(text: str, source_language: str, 
                       target_language: str, glossary_file: Optional[str] = None) -> Dict[str, str]:
    """
    Find all glossary terms in a text.
...
def apply_glossary_to_text(text: str, source_language: str, 
                           target_language: str, translated_text: str,
                           glossary_file: Optional[str] = None) -> str:
    """
    Apply glossary terms to a translated text.
    ...
    """
    glossary = get_glossary(glossary_file)
    return glossary.apply_glossary_to_text(text, source_language, target_language, translated_text)
...
def clear_glossary(language_pair: Optional[str] = None, glossary_file: Optional[str] = None) -> None:
    """
    Clear the glossary.
...
def import_glossary(import_file: str, merge: bool = True, glossary_file: Optional[str] = None) -> bool:
    """
    Import a glossary from a file.
