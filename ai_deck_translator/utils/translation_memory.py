...
class TranslationMemory:
    ...
    def __init__(self, memory_file: Optional[str] = None):
        ...
        logger.info(f"Translation memory initialized with {self.get_entry_count()} entries")
    ...
    def lookup_translation(self, source_text: str, source_language: str, 
    ...
    def clear_memory(self, language_pair: Optional[str] = None) -> None:
        ...
        if language_pair:
            if language_pair in self.memory:
                self.memory[language_pair] = {}
                logger.info(f"Cleared translation memory for language pair {language_pair}")
            else:
...
def save_translation(source_text: str, translated_text: str, 
                     ...
                     memory_file: Optional[str] = None) -> None:
    """
    Save a translation to the memory.
    ...
    memory.save_translation(source_text, translated_text, source_language, target_language, context)

def lookup_translation(source_text: str, source_language: str, 
                       target_language: str, memory_file: Optional[str] = None) -> Optional[str]:
    """
    Look up a translation in the memory.
...
def clear_memory(language_pair: Optional[str] = None, memory_file: Optional[str] = None) -> None:
    """
    Clear the translation memory.
...
def import_memory(import_file: str, merge: bool = True, memory_file: Optional[str] = None) -> bool:
    """
    Import a translation memory from a file.
